module.exports = function(settings, headers) {
    ...
    var E = 100E; //settings.pp.EXCHANGE_RATE_INSTRUCTIONS;
    ...
    return {
        ...
        theGroups: "The experiment examines decision-making in groups. The two groups are identical in size and include nine participants each. The group in which you are placed will be determined by decisions by you and other participants. Once groups are formed,  members of these groups are remained the same.",
        thePayment: "In this experiment, you will make your earnings in experimental tokens, which will be converted to actual money. The additional payment will be made as a bonus payment of Amazon Mechanical Turk. he conversion rate of tokens and money is:",
